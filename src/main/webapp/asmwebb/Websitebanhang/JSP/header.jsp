<header>
	...
	<nav
		...
		<div class="container-fluid">
			...
			<a href="/asignment2/index"><img
				src="asmwebb/Websitebanhang/images/logo.jpg" alt="" class="img-fluid"></a>
			<div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
				<!--------------------------------------------- Danh mục -------------------------------------------->
				<ul class="navbar-nav">
					<c:forEach var="category" items="${listCategory}">
						<li class="nav-item"><a class="nav-link"
							href="<c:url value='/danhmuc_servlet?maDM=${category.madm}'/>">${category.tendanhmuc}</a></li>
					</c:forEach>
					<li class="nav-item "><a href="asmwebb/login.jsp"
 ...
 <header>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top mb-1 p-3" style="background-color: #E5E5E5;">
        <div class="container-fluid"  >
            ...
            <a href="/asignment2/index"><img src="asmwebb/Websitebanhang/images/logo.jpg" alt="" class="img-fluid"></a>
            <div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
                <ul class="navbar-nav">
            ...
            <form action="/asignment2/giohang" method="post"> 
            <ul>
            <a href="" class="text-dark text-decoration-none me-4" name="id">
            <i class="bi bi-person-circle fs-4 "></i>
            		${user}
