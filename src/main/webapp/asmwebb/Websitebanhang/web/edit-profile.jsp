			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form class="asignment2/account/edit-profile" method="POST">
							...
							<div class="form-group form-button">
								<input type="submit" class="form-submit" value="Save Change" formaction="/asignment2/account/edit-profile" />
							</div>
						</form>
					</div>
					<div class="signup-image">
						<figure>
							<img src="web/image/profile.jpg">
						</figure>
						<a href="/asignment2/account/sign-out" class="signup-image-link">Sign out</a>
					</div>
				</div>
			</div>
		</section>
